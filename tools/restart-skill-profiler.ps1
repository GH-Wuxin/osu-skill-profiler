param(
    [ValidateSet('v100', 'v010-beta9.2', 'v010-beta9.1', 'v010-beta9', 'v010-beta8', 'v010-beta7', 'v010-beta6', 'v010-beta5', 'v010-beta4', 'v010-beta3', 'v010-beta2', 'v010-beta1', 'v096')][string]$Algorithm = 'v100',
...
$versionByAlgorithm = @{ 'v100' = '1.0.0'; 'v010-beta9.2' = '0.10.0-beta.9.2'; 'v010-beta9.1' = '0.10.0-beta.9.1'; 'v010-beta9' = '0.10.0-beta.9'; 'v010-beta8' = '0.10.0-beta.8'; 'v010-beta7' = '0.10.0-beta.7'; 'v010-beta6' = '0.10.0-beta.6'; 'v010-beta5' = '0.10.0-beta.5'; 'v010-beta4' = '0.10.0-beta.4'; 'v010-beta3' = '0.10.0-beta.3'; 'v010-beta2' = '0.10.0-beta.2'; 'v010-beta1' = '0.10.0-beta.1'; 'v096' = '0.9.6' }
