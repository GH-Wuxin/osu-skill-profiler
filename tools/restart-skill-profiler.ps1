param(
    [ValidateSet('v010-beta3', 'v010-beta2', 'v010-beta1', 'v096')][string]$Algorithm = 'v010-beta3',
...
$versionByAlgorithm = @{ 'v010-beta3' = '0.10.0-beta.3'; 'v010-beta2' = '0.10.0-beta.2'; 'v010-beta1' = '0.10.0-beta.1'; 'v096' = '0.9.6' }
