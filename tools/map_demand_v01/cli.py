"""CLI for Map Demand (0.10.0-beta.4 trial; beta.3/beta.2/beta.1/V0.96 replayable)."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    analyze.add_argument(
        "--algorithm",
        choices=("v010-beta4", "v010-beta3", "v010-beta2", "v010-beta1", "decoupled-v01", "v096", "v095", "v092", "v091", "v09", "v08", "v07", "v06"),
    ...
    bid_ui.add_argument("--algorithm", choices=("v010-beta4", "v010-beta3", "v010-beta2", "v010-beta1", "v096"), default=default_algorithm())
